...
# Build environment
grub_target_cc='cc'
grub_target_cc_version='cc (Debian 13.3.0-3) 13.3.0'
...
grub_target_cppflags='-Wno-unused-but-set-variable -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/i686-linux-gnu/13/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_version="2.12"
grub_package="grub"
grub_package_string="GRUB 2.12-5"
grub_package_version="2.12-5"
